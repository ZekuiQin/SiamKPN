...
class FixedScheduler(LRScheduler):
    def __init__(self, optimizer, lr=0.001, epochs=50, last_epoch=-1, **kwargs):
        self.start_lr = lr
        self.lr_spaces = self.start_lr * np.ones(epochs)

        super(FixedScheduler, self).__init__(optimizer, last_epoch)

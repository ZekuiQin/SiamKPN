...
Apart from the same motivation, SiamKPN also considered the cascade strategy for the anchor-free scheme to handle background distractors during tracking.
